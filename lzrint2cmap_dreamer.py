...
def main(config):
  ...
  if steps < 100:
    ...
    c.request('POST', '/toServer', '{"random": 1, "steps":300, "repeat":4, "discount":1.0, "training": 1}')
  ...
  while step < config.steps:
    ...
    if (step % config.eval_every == 0) and (has_trained):
      print('Evaluating')
      c = http.client.HTTPConnection('localhost', 8080)
      c.request('POST', '/toServer', '{"random": 0, "steps":300, "repeat":0, "discount":1.0, "training": 0}')
      doc = c.getresponse().read()
    ...
    print('Playing')
    c = http.client.HTTPConnection('localhost', 8080)
    c.request('POST', '/toServer', '{"random": 0, "steps":300, "repeat":0, "discount":1.0, "training": 1}')
    doc = c.getresponse().read()
