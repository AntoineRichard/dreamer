...
def main(config):
  ...
  if steps < 100:
    ...
    c.request('POST', '/toServer', '{"random": 0, "steps":500, "repeat":4, "discount":1.0, "training": 1}')
  ...
  while step < config.steps:
    ...
    print('Playing')
    c = http.client.HTTPConnection('localhost', 8080)
    c.request('POST', '/toServer', '{"random": 0, "steps":500, "repeat":0, "discount":0.9965, "training": 1}')
    doc = c.getresponse().read()
